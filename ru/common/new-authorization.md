...
5. Введит код из SMS и нажмите **Подтвердить**. Если вы не получили код или ввели некорректный, нажмите ссылку **Запросить новый**. Повторный код можно запросить через минуту.
