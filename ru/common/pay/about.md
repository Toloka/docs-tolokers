...
{% if locale == "ru-com"%}
В Толоке вы можете выводить средства, используя следующие способы: PayPal, Payoneer, ЮMoney, QIWI в зависимости от вашего региона.
{% endif %}
{% if locale != "ru-com"%}
В Толоке вы можете выводить средства, используя следующие способы: PayPal, Payoneer или QIWI или Систему быстрых платежей (СБП).
{% endif %}
