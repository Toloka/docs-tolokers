...
В Толоке вы можете выводить средства, используя следующие способы: PayPal, Payoneer, Papara{% if locale == "ru-com"%}, ЮMoney, QIWI или Систему быстрых платежей (СБП){% endif %}.
