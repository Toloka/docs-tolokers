...
В Толоке вы можете выводить средства, используя следующие способы: PayPal, Payoneer{% if locale == "ru-com"%}, ЮMoney, QIWI, ЮMoney или Систему быстрых платежей (СБП){% endif %}.
