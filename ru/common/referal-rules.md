...
- За проекты, которые выполнил друг. Проект считается выполненным, если его принял заказчик.
...
Сумма бонусов начисляется за проекты, выполненные друзьями в предыдущий день. Деньги зачисляются на ваш счет в Толоке.
...
- 20% от стоимости проектов за полевые проекты, выполненные в городах из списка.
...
- От 5 до 10% от суммы заработка за остальные проекты и бонусы, которые получил ваш друг от заказчиков.
