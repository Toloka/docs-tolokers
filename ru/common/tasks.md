...
Блокировка может быть временной. Например, если вы несколько раз подряд ошиблись при вводе капчи, вас могут заблокировать и попросить подтвердить, что вы реальный человек, а не робот. На первый раз вас, скорее всего, разблокируют. Но если ошибки при вводе капчи будут часто повторяться, вы можете потерять доступ к заданиям.
Если нарушения будут серьезными, то вас могут забанить навсегда.
