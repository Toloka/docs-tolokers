...
Cоветы о том, как избежать блокировки, описаны в разделе {% if locale=="ru-com" %}[Как быть успешным толокером](../tasks.md){% elsif locale=="en-com" %}[How to be a successful Toloker](../tasks.md){% endif %}
