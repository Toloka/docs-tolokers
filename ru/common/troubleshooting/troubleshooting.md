...
В Толоке есть система мониторинга — антифрод. Система автоматически проверяет поведение исполнителей и блокирует подозрительным аккаунтам доступ к платформе.
...
Если разблокировка возможна, выполните инструкции в сообщении.
