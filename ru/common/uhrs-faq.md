...
После того, как вы выполнили задания и закрыли сессию, подсчитывается вознаграждение — сколько заданий вы сделали. В течение 24 часов UHRS отправляет деньги на ваш счет в Толоке. Начисленные средства сначала недоступны для вывода из Толоки. Так как выполненные задания отправляются на проверку. Срок проверки — 7 дней. Вывод средств станет доступен после проверки.

В правом верхнем углу экрана указаны суммы:
