...
1. Откройте вкладку {% if platform=="browser" %}**{{ ui_worker.prfl }}**{% elsif platform=="android" %}**{{ mobile_android.profile }}**{% elsif platform=="ios" %}**{{ mobile_ios.profile.profile }}**{% endif %}.
